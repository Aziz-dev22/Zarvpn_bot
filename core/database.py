...
async def init_commercial_db():
    async with aiosqlite.connect(DB_NAME) as db:
        ...
        # جدول تنظیمات اتصال به سرورهای X-UI
        ...
        # جدول تنظیمات عمومی و اطلاعات ورود به پنل وب
        await db.execute('''CREATE TABLE IF NOT EXISTS settings (key TEXT PRIMARY KEY, value TEXT)''')
        
        # مقادیر اولیه برای جلوگیری از Internal Server Error
        defaults = [
            ...
            ('web_admin_user', 'admin'), ('web_admin_pass', 'secure_zar_pass_2026')  # 🔑 اطلاعات ورود پیش‌فرض
        ]
